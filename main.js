...
window.addEventListener("load", () => {
  ...
  // Остановить Lenis скролл перед анимацией
  ...
  tl.to(".preloader", {
    ...
    onComplete: () => {
      // Включить Lenis после завершения анимации
...
window.addEventListener("scroll", function () {
  ...
  if (st < hideOffset) {
    // Принудительно скрывать nav, если близко к верхушке
    hideNav();
